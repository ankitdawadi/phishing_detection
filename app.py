...
def getURL():
	if request.method == 'POST':
		...
		infile = open('RandomForrestModel.sav','rb')
		...
		if (predicted_value==-1):
			return render_template('index.html', sites=sites.query.all(), prediction_text='This is legit Website!')
		else:
			return render_template('index.html', sites=sites.query.all(), prediction_text='This website is phishing')
    # return render_template("index.html")
